				...
				<CardContent class="space-y-4">
					...
					<div class="space-y-2">
						...
						<div class="space-y-1">
							...
							<p class="text-xs text-gray-500">
								💡 <strong>Tip:</strong> For Google Drive images: Share the file publicly and use this
						...
						<div class="space-y-4">
							...
							<div class="space-y-2">
								...
								<div class="grid grid-cols-2 gap-4 sm:grid-cols-3 md:grid-cols-4">
									{#each photoUrls() as url, index}
										<div class="relative aspect-video overflow-hidden rounded-lg border bg-gray-50">
											<img
												src={url}
												alt="Property photo {index + 1}"
